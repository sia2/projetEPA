...
if(isset($_POST['post'])) $post=(int)$_POST['post']+0; elseif(isset($_GET['post'])) $post=(int)$_GET['post']+0; else $post=0;
...
//Determine the last possible page. If it's less than $page, $page changes its value.
if($rowd=db_simpleSelect(0, $Tt, 'posts_count', 'topic_id', '=', $topic)) $numCurRows=$rowd[0]; else $numCurRows=0;
$page=pageChk($page, $numCurRows, $viewmaxreplys);
