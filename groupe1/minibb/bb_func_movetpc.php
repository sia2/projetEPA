<?php
/*
This file is part of miniBB. miniBB is free discussion forums/message board software, without any warranty. See COPYING file for more details. Copyright (C) 2004,2015 Paul Puzyrev, Sergei Larionov. www.minibb.com
...
if(isset($_POST['forumWhere'])) $forum_id=(int)$_POST['forumWhere']+0; else $forum_id=0;
