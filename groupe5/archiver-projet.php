<?php 
session_start();
if(!isset($_SESSION['pseudo']) and !isset($_SESSION['mdp'] and !isset($_SESSION['statut'])) {
	header('location: ../groupe4/index.php');
	exit();
}

if(!has_right($_SESSION['statut'])) {
	header('location: ../groupe4/index.php');
	exit();
}
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <div class="row">
			...
			<div class="alert alert-success" role="alert">
					<a href="#" class="alert-link">Votre projet a bien été archivé ! </a>
			</div>
					 
			<button type="button" class="btn btn-default"><a href="<?php echo $page_retour; ?>">Retour</a></button>
