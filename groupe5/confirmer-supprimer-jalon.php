...
$num_subvention = '';
$page_retour = "#";
$page_traite = 'confirmer-supprimer-jalon';
$id_jalon = '';


if( isset($_GET['jl']) and isset($_GET['pj'])) { 
	if (!empty($_GET['jl']) and !empty($_GET['pj'])) {
		$page_traite = 'confirmer-supprimer-jalon.php';
		$id_jalon = $_GET['jl'];
		$id_projet = $_GET['pj'];
...
if( isset( $_POST['confirmer'])) { 
		...
		header('location: supprimer-jalon.php?pj=' . $id_projet ); 	  
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <div class="row">
			...
			<div class="alert alert-success" role="alert">
					<a href="#" class="alert-link">Souhaitez vous supprimer le jalon ? </a>
				</div>
