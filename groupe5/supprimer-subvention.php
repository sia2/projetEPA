		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <div class="row">
			...
			<div class="alert alert-success" role="alert">
					<a href="#" class="alert-link">Votre subvention a bien été supprimée ! </a>
			</div>
					 
			<button type="button" class="btn btn-default"><a href="<?php echo $page_retour; ?>">Retour au projet</a></button>
