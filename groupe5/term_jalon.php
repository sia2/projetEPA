      ...
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="alert alert-success" role="alert">
				<a href="#" class="alert-link">Votre jalon a bien été modifié. Il est maintenant terminé. </a>
			</div>
				  
				<button type="button" class="btn btn-default"><a href="<?php echo $page_projet; ?>">Retour au projet</a></button>
			 
				<button type="button" class="btn btn-default"><a href="<?php echo $page_jalon; ?>">Passer au jalon suivant</a></button>
        </div>
      </div>
    </div>
