...
if( isset($_GET['pj'])) { 
	if (!empty($_GET['pj'])) {
		$page_traite = 'confirmer-archivage-projet.php';
...
if( isset( $_POST['confirmer'])) { 
		...
		$sql = "UPDATE projet SET archivage='oui' WHERE id_projet=" . $id_projet; 
		//$sql = "DELETE FROM jalon WHERE id_jalon=" . $id_jalon; 

		//on insère les informations du formulaire dans la table 
		mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error()); 

		header('location: archiver-projet.php' ); 	  
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <div class="row">
			...
			<div class="alert alert-success" role="alert">
					<a href="#" class="alert-link">Souhaitez vous archiver le projet ? </a>
				</div>
